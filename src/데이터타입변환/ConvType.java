package 데이터타입변환;
// 데이터 타입변환이란 선언된 변수의 데이터 타입을 다른 타입으로 변경 하는 것
// 묵시적 타입 변환(자동 타입 변환): 컴파일러 자동으로 해주며 유리한 방형으로 타입 변환이 됨
// 명시적 타입 변환 : 개발자가 의도적으로 형을 변경 하는것
...
public class ConvType {
    public static void main(String[] args) {
        ...
        String phoneNunber = "01000000000";
        int number= Integer.parseInt(phoneNunber);
